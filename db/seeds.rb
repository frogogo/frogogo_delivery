...
DeliveryZone.create!(courier_fee: 799, pickup_fee: 699, free_delivery_gold_threshold: 4000, free_delivery_threshold: 4500, zone: 5, country: russia)
...
# Create providers
Provider.create!(code: 'russian-post', name: 'RussianPostPickup')
